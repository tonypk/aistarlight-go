...
func phConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL PAYABLE", "TOTAL"},
...
func sgConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL (SGD)", "TOTAL"},
...
func lkConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "BILL TOTAL", "NET TOTAL", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL PAYABLE", "BALANCE DUE", "TOTAL (LKR)", "TOTAL"},
