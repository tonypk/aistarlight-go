...
func phConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL PAYABLE", "TOTAL", "支付", "付款", "应付", "合计", "总计", "消费"},
...
func sgConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL (SGD)", "TOTAL", "支付", "付款", "应付", "合计", "总计", "消费"},
...
func lkConfig() Config {
	return Config{
		...
		TotalLabels:    []string{"GRAND TOTAL", "TOTAL AMOUNT", "BILL TOTAL", "NET TOTAL", "AMOUNT DUE", "NET AMOUNT", "TOTAL DUE", "TOTAL PAYABLE", "BALANCE DUE", "TOTAL (LKR)", "TOTAL", "支付", "付款", "应付", "合计", "总计", "消费"},
		...
		ZeroRatedLabels: []string{"ZERO RATED", "ZERO-RATED", "0% VAT"},
		GovtKeywords:   []string{"inland revenue", "sri lanka customs", "government of sri lanka", "ministry of", "dept of inland revenue", "department of customs"},
